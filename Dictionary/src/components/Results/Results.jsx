    ...
    return (
        <>
            ...
            <div className="firstPartOfSpeech">
                ...
                {inputValue != undefined && (
                    <>
                        ...
                        {data.length >= 1 ? <h2 className="inline-block mr-4 text-2xl font-semibold">{data[0].meanings[0].partOfSpeech}</h2> : ''}
                    </>
                )}
            ...
            <div className="meaning">
                {/* if data array length exists render @Meaning@ */}
                {data.length >= 1 ? <p className="mt-8 text-gray-400 text-lg font-semibold">Meaning</p> : ''}
            ...
            {/* if data array length is atleast 1, it renders @Synonyms@ else it renders nothing*/}
            {data.length >= 1
            ...
            <div className="secondPartOfSpeech mt-5">
                ...
                {inputValue != undefined && (
                    <>
                        ...
                        {data && data[0].meanings.length <= 3  ? ' ' : <h2 className="inline-block mr-4 text-2xl font-semibold">{data[0].meanings[1].partOfSpeech}</h2>}
                    </>
                )}
